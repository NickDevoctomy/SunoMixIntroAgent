...
This module defines the web search tool which uses the Tavily API
to search the web for information about musical artists.
"""
...
def create_web_search_tool():
    ...
    Returns:
        Tool: Configured web search tool
    """
    # Get Tavily API key
